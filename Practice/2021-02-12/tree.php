...
foreach ($data as $key => $value) {
    $tree['category'][$value['category']]['name']=$value['categoryname'];
    $tree['category'][$value['category']]['attribute'][$value['attribute']]['name']=$value['attributename'];
    $tree['category'][$value['category']]['attribute'][$value['attribute']]['option']['name']=$value['optionname'];
}
