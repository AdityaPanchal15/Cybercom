...
const studios = [
	{
		...
		name: 'Paramount',
		location: 'Hollywood',
		movieIds: ['movie_0', 'movie_1', 'movie_2'],
	},
	{
		id: 'studio_1',
		name: 'Universal',
...
const typeDefs = gql`
	...
	type Mutation {
		createMovie(title: String!, tagline: String, revenue: Int): Movie
		addDirectorToMovie(movieId: ID!, director: DirectorInput): Movie
	}
`;
