<template>
  <div class="mx-2">
    ...
    <v-row class="mt-3" no-gutters>
      <v-col>
        <side-panel :product-links="product[productName]['productLinks']" />
      </v-col>
      <v-col>
        <product-images
          :img-src="product[productName]['img']"
          :categories="product[productName]['categories']"
          :product-links="product[productName]['productLinks']"
        />
      </v-col>
    </v-row>
  </div>
